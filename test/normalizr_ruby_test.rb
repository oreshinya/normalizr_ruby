...
class NormalizrRubyTest < Minitest::Test
  def setup
    @shinji = User.create(first_name: "Shinji", last_name: "Okazaki")
  ...
  def test_normalized
    expected = {
      ...
      entities: {
        ...
        users: {
          1 => {id: 1, firstName: "Shinji", fullName: "Shinji Okazaki", reactions: [1]},
          2 => {id: 2, firstName: "Keisuke", fullName: "Keisuke Honda", reactions: [2]}
        }
      }
    }
